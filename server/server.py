import psycopg2
from server.tasksFuncs import createTaskTable, createTask, createSubtask, deleteTask
        ...
        while True:
            ...
            if action == "login":
                ...
                try:
                    ...
                    response = {"deleted_task": True, "task_id": int(task_id)}
                except Exception as e:
                    response = {"deleted_task": False, "error": str(e)}
            else:
